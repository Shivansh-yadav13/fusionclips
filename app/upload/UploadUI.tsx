  ...
  const handleChange = useCallback(
    async (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (user) {
        ...
        setVideoURL(`https://mzwpeqplxjiupysnwteo.supabase.co/storage/v1/object/public/temp_clip_bucket/fc7a6a6c-bb2b-4e16-9d30-0c3fdc53a65b/clip.mp4`);
        const cap = await generateCaptions(`https://mzwpeqplxjiupysnwteo.supabase.co/storage/v1/object/public/temp_clip_bucket/fc7a6a6c-bb2b-4e16-9d30-0c3fdc53a65b/clip.mp4`);
        setCaptions(cap);
      }
    },
    [user]
